...
user_input = input("Welcome to the Data Cleaning Tool. Choose [1] Drop empty rows/columns [2] Drop Column [3] Drop Row [4] Change Column Name [5] Modify Single Cell [6] Compute Mean [7] Compute Median : ")
...
if int(user_input) == 1:
    ...
    column_name_input = input("Enter the name of the column: ")
